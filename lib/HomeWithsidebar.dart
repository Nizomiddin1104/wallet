...
class _homeWithSidebarState extends State<homeWithSidebar> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    rotationController = AnimationController(duration: Duration(milliseconds: 100), vsync: this);
    super.initState();
  }
  @override
  Widget build(BuildContext context) {
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text("Asal Karimova", style: TextStyle(
                                  fontSize: 19,
                                  fontWeight: FontWeight.w700
                              ),),
                              Text("Seattle Toshkent", style: TextStyle(
                                  fontSize: 13,
